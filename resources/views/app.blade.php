...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"  @class(['dark' => ($appearance ?? 'system') == 'dark'])>
    <head>
        ...
        <meta name="description" content="القرآن الكريم لجامعة القصيم — اقرأ القرآن الكريم بالرسم العثماني (مصحف المدينة) مع التلاوة الصوتية بأصوات مشاهير القرّاء، التفاسير وترجمة المعاني، البحث، ووضع الحفظ.">
        <meta property="og:type" content="website">
        <meta property="og:site_name" content="جامعة القصيم">
        <meta property="og:locale" content="ar_SA">
        <meta property="og:title" content="القرآن الكريم — جامعة القصيم">
        ...
        <meta property="og:image" content="{{ url('/og-image.png').'?v=4' }}">
        <meta property="og:image:width" content="1200">
        <meta property="og:image:height" content="630">
        <meta property="og:url" content="{{ url()->current() }}">
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="القرآن الكريم — جامعة القصيم">
        <meta name="twitter:description" content="القرآن الكريم بالرسم العثماني مع التلاوة والتفسير والبحث — جامعة القصيم.">
        <meta name="twitter:image" content="{{ url('/og-image.png').'?v=4' }}">
        ...
        <x-inertia::head>
            <title>القرآن الكريم | جامعة القصيم | Qassim University</title>
        </x-inertia::head>
    </head>
